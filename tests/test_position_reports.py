...
class TestPositionReports(TestCase):
    ...
    def test_basics(self):
        ...
        self.assertAlmostEqual(-118.2634, m['lon'])
        self.assertAlmostEqual(33.7302, m['lat'])

    def test_as_location(self):
        m = simpleais.parse('!ABVDM,1,1,,A,15NaEPPP01oR`R6CC?<j@gvr0<1C,0*1F')
        location = m.location()
        self.assertAlmostEqual(-118.2634, location[0])
        self.assertAlmostEqual(33.7302, location[1])
    ...
    def test_bad_values(self):
        ...
        self.assertAlmostEqual(3.0226, m['lat'])
